<template>
  <div class="login-layout-main hidden flex-column flex-center">
    <div class="login-layout-container hidden size-large shadow-info border-small bg-fff flex-row flex-alg">
      <!-- qrcode  /////////////////////////////////////////////// -->
      <div class="login-layout-qrcode h-full border-base flex-column flex-alg" style="width: 40%;">
      ...
      <!-- login /////////////////////////////////////////////// -->
      <div class="login-layout-lg pl-10 bg-fff h-full border-base flex-column flex-alg" v-if="LoginStatus == 'login'" style="width: 60%;">
        ...
        <div class="login-layout-lg-container pt-10 h-full flex-column flex-alg">
          ...
          <div class="w-full select-none  flex-row flex-between flex-alg">
            ...
            <div class="flex-row">
              <IconFont class="text-primary mr-4" icon="unlock" />
              <el-link :underline="false" @click="LoginStatus = 'forget'" type="success">忘记密码</el-link>
            </div>
          </div>
          <div class="w-full flex-row flex-alg mt-20 flex-around">
            <el-button @click="login" type="success">登录</el-button>
            <el-link :underline="false" @click="LoginStatus = 'register'" type="info">去注册 -></el-link>
          </div>
          <div class="w-full flex-column flex-alg mt-18">
            <div class="w-full flex-row flex-alg flex-around mb-10">
              <IconFont class="point text-success" icon="weixin" :size="25" />
              <IconFont class="point" icon="QQ" :size="25" />
              <IconFont class="point text-primary" icon="twitter" :size="25" />
              <IconFont class="point text-primary" icon="zhifubao" :size="25" />
            </div>
            <el-link type="info" @click="OtherMethodLogin">其他方式登录>></el-link>
          </div>
        </div>
      </div>
      <!-- login end /////////////////////////////////////////////// -->
      ...
      <!-- register /////////////////////////////////////////////// -->
      <div class="login-layout-lg pl-10 bg-fff h-full border-base flex-column flex-alg" v-else-if="LoginStatus == 'register'" style="width: 60%;">
        ...
        <div class="login-layout-lg-container pt-10 h-full flex-column flex-alg">
          ...
          <div class="w-full flex-row flex-alg mt-10 flex-around">
            ...
            <el-link :underline="false" @click="LoginStatus = 'login'" type="info">&lt;- 返回</el-link>
          </div>
        </div>
      </div>
      <!-- register end /////////////////////////////////////////////// -->
      ...
      <!-- forget /////////////////////////////////////////////// -->
      <div class="login-layout-lg pl-10 bg-fff h-full border-base flex-column flex-alg" v-else style="width: 60%;">
