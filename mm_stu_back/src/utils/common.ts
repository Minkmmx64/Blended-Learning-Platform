...
export const province = { 
  ...
  "西藏自治区": ["拉萨市", "日喀则市", "昌都市", "林芝市", "山南市", "那曲市", "阿里地区"], "陕西省": ["西安市", "铜川市", "宝鸡市", "咸阳市", "渭南市", "延安市", "汉中市", "榆林市", "安康市", "商洛市"], 
...
interface Elcascader {
  value: string,
  label: string,
  children: Elcascader[]
}
export const TProvinceToElCascader = () : Elcascader[] => {
  const ProvinceToElCascader = [];
  for(const K in province) {
    const o = {} as Elcascader;
    o.value = K, o.label = K, o.children = [];
    (province[K] as string[]).map( v => {
      const ch = {} as Elcascader;
      ch.value = v, ch.label = v;
      o.children.push(ch);
    })
    ProvinceToElCascader.push(o);
  }
